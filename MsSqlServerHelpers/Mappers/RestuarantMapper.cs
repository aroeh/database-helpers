...
namespace MsSqlServerHelpers.Mappers;

public static class RestuarantMapper
{
    /// <summary>
    ...
    public static Restuarant[] MapRestuarantsAndLocation(DataTable table) => [.. table.AsEnumerable().Select(row => MapRestuarantAndLocation(row))];
    ...
    /// <param name="table">DataTable from the resulting query or command</param>
    /// <returns>Array of Restuarants</returns>
    public static Restuarant[] MapRestuarants(DataTable table) => [.. table.AsEnumerable().Select(row =>MapRestuarant(row))];
    ...
    public static Restuarant MapRestuarantAndLocation(DataRow row)
    {
    ...
    /// <param name="row">DataRow from the resulting query or command</param>
    /// <returns>Restuarant</returns>
    public static Restuarant MapRestuarant(DataRow row)
    {
    ...
    public static Location MapLocation(DataRow row)
    {
        return new Location
        {
    ...
    public static DataTable MapRestuarantsToDataTable(Restuarant[] restuarants)
    {
    ...
    public static DataTable MapRestuarantAddressesToDataTable(Restuarant[] restuarants)
    {
