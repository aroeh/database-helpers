...
public class RestuarantRepo(ILogger<RestuarantRepo> log, IRestuarantData data) : IRestuarantRepo
{
    ...
    public async Task<Restuarant[]> GetAllRestuarants()
    {
        ...
        Restuarant[] restuarants = await restuarantData.GetAllRestuarants();
    ...
    public async Task<Restuarant[]> FindRestuarants(string name, string cuisine)
    {
        ...
        Restuarant[] restuarants = await restuarantData.FindRestuarants(name, cuisine);
    ...
    public async Task<bool> InsertRestuarant(Restuarant restuarant)
    {
        ...
        ItemResponse<Restuarant> result = await restuarantData.InsertRestuarant(restuarant);
    ...
    {
        logger.LogInformation("Adding new restuarant");
        ItemResponse<Restuarant>[] results = await restuarantData.InsertRestuarants(restuarants);
    ...
    public async Task<bool> UpdateRestuarant(Restuarant restuarant)
    {
        ...
        ItemResponse<Restuarant> result = await restuarantData.UpdateRestuarant(restuarant);
